...
pq_signing_suite!(
    doc_prefix: "SPHINCS+ SHA2-128s-simple",
    keypair_fn: sphincs_keypair,
    sign_fn: sphincs_sign,
    verify_fn: sphincs_verify,
    ffi_keypair: foretias_sphincs_sha2_128s_keypair,
    ffi_sign: foretias_sphincs_sha2_128s_sign,
    ffi_verify: foretias_sphincs_sha2_128s_verify
);

/* ── SHA2-256f-simple (NIST Level 5, TBID dual-key PQ component) ─── */

pq_signing_suite!(
    doc_prefix: "SPHINCS+ SHA2-256f-simple",
    keypair_fn: sphincs_sha2_256f_keypair,
    sign_fn: sphincs_sha2_256f_sign,
    verify_fn: sphincs_sha2_256f_verify,
    ffi_keypair: foretias_sphincs_sha2_256f_keypair,
    ffi_sign: foretias_sphincs_sha2_256f_sign,
    ffi_verify: foretias_sphincs_sha2_256f_verify
);
