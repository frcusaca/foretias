//! NodeMetrics — atomic counters for observability (v0.5).
...
/// Thread-safe atomic counters for node-level observability.
...
impl NodeMetrics {
    ...
    /// Snapshot all counters as a JSON object.
...
impl fortias_core::fortias::callbacks::AutoAttestObserver for NodeMetrics {
