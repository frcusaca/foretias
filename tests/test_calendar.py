...
def _make_valid_genesis(tbid, pk, sk):
    """Create a genesis TickRecord (forward_fortis=None, backward_fortis computed)."""
    genesis_ma = (
        tbid
        + b"\x00" * 8
        + pk
    ...
    return TickRecord(tick_number=0, public_key=pk, forward_fortis=None, backward_fortis=backward)
...
class TestPersistence:
    def test_save_load_roundtrip(self):
        ...
        assert loaded.ticks[0].forward_fortis is None
