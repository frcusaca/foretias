...
def _make_genesis():
    """Create a genesis tick record (forward_fortis=None, backward_fortis computed)."""
    ...
    genesis = TickRecord(
        ...
        forward_fortis=None, backward_fortis=genesis_backward,
    )
...
class TestVerifyPair:
    ...
    def test_backward_fortis_required_for_non_genesis(self):
        """backward_fortis must never be None for non-genesis ticks."""
        sk, pk = generate_keypair()
